# -*- encoding: utf-8 -*-
# stub: schedulability 0.2.0.pre20160715112144 ruby lib

Gem::Specification.new do |s|
  s.name = "schedulability"
  s.version = "0.2.0.pre20160715112144"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<hoe-deveiate>, ["~> 0.4"])
      ...
      s.add_dependency(%q<hoe-deveiate>, ["~> 0.4"])
